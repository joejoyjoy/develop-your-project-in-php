            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-xl-100">
                    <div class="card rounded-3 text-black container">
                        <form action="../logic/validateSignUp.php" method="POST" enctype="multipart/form-data" class="box">
                            <!-- NAME -->
                            ...
                            <div class="mb-3">
                                ...
                                <a href="login.php" class="btn btn-danger" style="background-color: #343A3F; border: #343A3F;">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
...
Volver de a una acción hacia atrás
-->